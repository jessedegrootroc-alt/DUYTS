...
def paginas():
    """Elke pagina met zijn gewicht. De homepage en de hoofddiensten staan hoog,
    ...
    rijen += [('over-ons.html', '0.7'), ('werkwijze.html', '0.7'), ('het-team.html', '0.6'),
              ('historie.html', '0.5'), ('registerconstructeur.html', '0.5'),
              ('vacatures.html', '0.6')]
