...
| | Waarom |
|---|---|
| **gzip of brotli** op html, css, js, svg, xml | `styleguide.min.css` gaat van 60 kB naar 10,7 kB, de HTML van 65 kB naar 10,8 kB |
...
Dat minificeert de stylesheets en scripts en schrijft de 73 pagina's opnieuw,
...
- `BASIS` in `_generator/schil.py` staat op `https://www.duyts.nl`. Daar komen
  de canonical-links, de sitemap en de deelafbeelding uit. Wijzig dat als de
  site op een ander domein komt te staan.
